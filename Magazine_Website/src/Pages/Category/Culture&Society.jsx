...
const cultureArticles = [
    {
        title: "India's Traditional Art Forms Revived",
        image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80",
        date: "August 16, 2025",
        summary:
            "Young artists are bringing new life to India's ancient art forms, blending tradition with modernity.",
        link: "indian-art-revival",
    },
    {
        ...
        date: "August 15, 2025",
        summary:
            "Explore how festivals across India foster unity and cultural exchange.",
        link: "festivals-unite-communities",
    },
    {
        title: "The Rise of Contemporary Indian Literature",
        image: "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=800&q=80",
        date: "August 14, 2025",
        summary:
            "Meet the authors and poets shaping the voice of modern India.",
        link: "contemporary-indian-literature",
    },
    {
        title: "Women Leading Social Change",
        image: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=800&q=80",
        date: "August 13, 2025",
        summary: "Stories of women making a difference in their communities.",
        link: "women-social-change",
    },
    {
        title: "Urbanization and Its Impact on Society",
        image: "https://images.unsplash.com/photo-1468071174046-657d9d351a40?auto=format&fit=crop&w=800&q=80",
        date: "August 12, 2025",
        summary:
            "How rapid urban growth is transforming Indian society and culture.",
        link: "urbanization-impact",
    },
    {
        ...
        date: "August 11, 2025",
        summary:
            "Efforts to keep India's diverse languages alive for future generations.",
        link: "preserving-languages",
    },
];

const rest = cultureArticles.slice(3);
    ...
    <div className="min-h-screen pb-10 bg-white relative overflow-x-hidden">
        ...
        <div className="relative flex flex-col items-center justify-center py-16 mb-10">
            ...
            <p className="relative z-10 text-lg md:text-2xl text-[#1a1a1a] font-medium max-w-2xl text-center mb-2">
                Stories and trends that shape our communities, beliefs, and way of life in India.
            </p>
        ...
        <section className="relative max-w-7xl mx-auto px-4 py-12 flex flex-col items-center">
            ...
            <div className="relative w-full flex flex-wrap justify-center gap-8 z-10">
                {cultureArticles.slice(0, 3).map((article, idx) => (
                    <div
                        key={article.title}
