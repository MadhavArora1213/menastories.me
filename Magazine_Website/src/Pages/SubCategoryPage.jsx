                    ...
                    {article.featuredImage ? (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          const fallback = parent.querySelector('.article-fallback');
                          if (!fallback) {
                            const fallbackDiv = document.createElement('div');
                            fallbackDiv.className = 'article-fallback w-full h-full bg-gradient-to-br from-[#e3e7f7] to-[#162048] flex items-center justify-center';
                    ...
                    {videoArticle.thumbnailUrl ? (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          if (!fallback) {
                            const fallbackDiv = document.createElement('div');
                            fallbackDiv.className = 'video-fallback w-full h-full bg-gradient-to-br from-red-100 to-pink-100 flex items-center justify-center';
                            fallbackDiv.innerHTML = `
