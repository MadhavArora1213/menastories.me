...
const createBulkAdminUsers = async () => {
  try {
    console.log('Starting bulk admin user creation...');
    ...
    console.log('\nBulk admin user creation completed successfully!');

  } catch (error) {
    console.error('Error in bulk admin user creation:', error);
  } finally {
...
module.exports = createBulkAdminUsers;