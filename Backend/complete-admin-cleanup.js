const { Admin, Role, Article, VideoArticle, Event } = require('./models');
const sequelize = require('./config/db');

async function completeAdminCleanup() {
  try {
    console.log('🧹 Complete admin cleanup with all foreign key constraints...\n');
    ...
    for (const admin of usersToDelete) {
      ...
      if (articleCount > 0 || videoArticleCount > 0 || eventCount > 0) {
